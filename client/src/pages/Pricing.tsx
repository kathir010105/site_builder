  ...
  return (
    ...
    <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h[80vh'>
      ...
      <div className='pt-14 py-4 px-4 '>
                ...
                <p className='mx-auto text-center text-sm max-w-md mt-15 text-white/60 font-light'>Project <span className='text-white'>Creation / Revision </span>consume <span className='text-white'>5 credits</span>. You can purchase more credits to create more projects.</p>
    </div>
    <Footer/>
    </>
  )
